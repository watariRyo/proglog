...
import (
	...
	"github.com/watariRyo/proglog/internal/agent"
	"github.com/watariRyo/proglog/internal/config"
)
...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().Bool("bootstrap", false, "Bootstarp the cluster")
	...
	cmd.Flags().String("server-tls-key-file", "", "Path to tls key.")
	cmd.Flags().String("server-tls-ca-file", "", "Path to certificate authority")
